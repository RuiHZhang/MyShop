<template>
    <div class="trade-container">
        ...
        <div class="content">
            ...
            <div class="detail">
                <h5>商品清单</h5>
                <ul class="list clearFix" v-for="detail in detailArrayList" :key="detail.id">
                    <li>
        ...
        <div class="sub clearFix">
            <a class="subBtn" style="cursor:pointer" @click="submitOrder(orderList)">提交订单</a>
        </div>
    </div>
</template>
...
export default {
    ...
    mounted(){
        this.$store.dispatch('getAddressInfo')//请求地址信息
        this.$store.dispatch('getOrderInfo')// 请求商品信息
    },
