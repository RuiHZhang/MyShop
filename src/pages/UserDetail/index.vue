...
<script>
  ...
  import MyZoom from './MyZoom/MyZoom.vue'
  ...
  export default {
    ...
    mounted(){
      // 派发请求获取detail数据,携带skuid参数（对应图片的id）
    ...
    methods:{
      ...
      async addToCart(){
        try{
          ...
          // 若成功则经进行路由跳转、路由跳转注意要携带参数
          // 失败则对用户进行警告
          sessionStorage.setItem("SKUINFO",JSON.stringify(this.skuInfo))//使用会话储存将产品信息储存给购物车传
